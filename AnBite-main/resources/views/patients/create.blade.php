...
<head>
    ...
    <style>
        ...
        * {
        ...
        .zone:hover {
            fill: rgba(26,90,26,0.13);
        }

        .zone.selected {
            fill: rgba(45,106,45,0.25);
            stroke: #2d6a2d;
            stroke-width: 1.5;
        }
...
<main class="main">
    ...
    <div class="page-header">
        ...
        <div>
            ...
            <div class="page-sub">
                Add a new bite incident patient
            </div>
        ...
        <div class="form-section">
            ...
            <div class="section-header">
                ...
                <div>
                    ...
                    <div class="section-sub">
                        Basic details of the bite incident patient
                    </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <label>
                        Contact Number
                        <span style="color:#c4c9d4;font-weight:400;text-transform:none;">
                            (Guardian/Relative)
                        </span>
                    </label>
        ...
        <div class="form-section">
            ...
            <div class="section-header">
                ...
                <div>
                    ...
                    <div class="section-sub">
                        Details about the bite or scratch incident
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="select-wrap">
                        ...
                        <select name="type_of_exposure" id="type_of_exposure_select" required>
                            ...
                            <option value="Scratch" {{ old('type_of_exposure') == 'Scratch' ? 'selected' : '' }}>
                                Scratch
                            </option>

                            <option value="Bite" {{ old('type_of_exposure') == 'Bite' ? 'selected' : '' }}>
                                Bite
                            </option>

                            <option value="Scratch and Bite" {{ old('type_of_exposure') == 'Scratch and Bite' ? 'selected' : '' }}>
                                Scratch and Bite
                            </option>

                            <option value="Non-Bite/Non-Scratch" {{ old('type_of_exposure') == 'Non-Bite/Non-Scratch' ? 'selected' : '' }}>
                                Non-Bite / Non-Scratch
                            </option>
                ...
                <div class="form-group full">
                    ...
                    <div class="select-wrap">
                        ...
                        <select name="source_of_exposure" id="source_of_exposure" required>
                            ...
                            <option value="" disabled selected>
                                Select animal and breed type
                            </option>

                            <option value="Dog - With Breed" {{ old('source_of_exposure') == 'Dog - With Breed' ? 'selected' : '' }}>
                                Dog — With Breed
                            </option>

                            <option value="Dog - Without Breed" {{ old('source_of_exposure') == 'Dog - Without Breed' ? 'selected' : '' }}>
                                Dog — Without Breed
                            </option>

                            <option value="Cat - With Breed" {{ old('source_of_exposure') == 'Cat - With Breed' ? 'selected' : '' }}>
                                Cat — With Breed
                            </option>

                            <option value="Cat - Without Breed" {{ old('source_of_exposure') == 'Cat - Without Breed' ? 'selected' : '' }}>
                                Cat — Without Breed
                            </option>

                            <option value="other animal" {{ old('source_of_exposure') == 'other animal' ? 'selected' : '' }}>
                                Other Animal
                            </option>
        ...
        <div class="form-section">
            ...
            <div class="section-header">
                ...
                <div>
                    ...
                    <div class="section-sub">
                        Click on the body diagram to mark the affected area
                    </div>
            ...
            <input
                ...
                name="wound_site"
                id="wound_site_input"
                value="{{ old('wound_site') }}"
            >

            <input
                type="hidden"
                name="bite_category"
                id="bite_category_input"
                value="{{ old('bite_category') }}"
            >
            ...
            <div class="exposure-btn-row" id="exp-pill-row">
                ...
                <button type="button" class="exp-pill" data-val="Scratch">
                    Scratch
                </button>

                <button type="button" class="exp-pill" data-val="Bite">
                    Bite
                </button>

                <button type="button" class="exp-pill" data-val="Scratch and Bite">
                    Scratch and Bite
                </button>

                <button type="button" class="exp-pill" data-val="Non-Bite/Non-Scratch">
                    Non-Bite / Non-Scratch
                </button>
            ...
            <div class="wound-tags" id="wound-tags">
                ...
                <span class="no-site-placeholder" id="no-site-msg">
            ...
            <div class="category-auto-box" id="cat-auto-box">
                ...
                <span class="cat-badge cat-none" id="cat-badge-auto">
                    —
                </span>

                <div>

                    <div class="cat-info-title" id="cat-auto-title">
                        Select exposure type and wound site
                    </div>
        ...
        <div class="form-section">
            ...
            <div class="section-header">
                ...
                <div>
                    ...
                    <div class="section-sub">
                        Treatment and referral details
                    </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <label>
                        Category Level of Bite
                    </label>

                    <div class="select-wrap">

                        <select id="category_level_select" name="bite_category">

                            <option value="" disabled selected>
                                Select category
                            </option>

                            <option value="1" {{ old('bite_category') == '1' ? 'selected' : '' }}>
                                Category 1
                            </option>

                            <option value="2" {{ old('bite_category') == '2' ? 'selected' : '' }}>
                                Category 2
                            </option>

                            <option value="3" {{ old('bite_category') == '3' ? 'selected' : '' }}>
                                Category 3
                            </option>
                ...
                <div class="form-group">
                    ...
                    <div class="select-wrap">
                        ...
                        <select name="referred_clinic">
                            ...
                            <option
                                value="Batangas City Health Office - Animal Bite Treatment Center"
...
<div class="footer-bar">
    ...
    <div class="footer-bar-right">
        ...
        <button type="submit" form="patient-form" class="btn-save">
            &#10003; Save Patient
        </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const CAT_INFO = {
        ...
        1: {
            label: 'Category 1 — No wound',
            desc: 'Touching or feeding of animals, licks on intact skin. No wound, no mucosal contact.',
            cls: 'cat-1'
        },

        2: {
            label: 'Category 2 — Minor exposure',
            desc: 'Nibbling of uncovered skin, minor scratches or abrasions without bleeding.',
            cls: 'cat-2'
        },

        3: {
            label: 'Category 3 — Severe exposure',
            desc: 'Transdermal bites/scratches, licks on broken skin, or exposure to head/neck/hands/feet.',
            cls: 'cat-3'
        }
    ...
    function renderTags() {
        ...
        if (selected.size === 0) {
            ...
            ph.textContent =
                exposureType === 'Non-Bite/Non-Scratch'
    ...
    function updateCategory() {
        ...
        if (exposureType === 'Non-Bite/Non-Scratch') {
            ...
            selected.forEach(id => {
                ...
                if (el && HIGH_RISK.has(el.dataset.label)) {
                    hasHighRiskZone = true;
                }
    ...
    function updateSidebarLayout() {
        ...
        const sidebarWidth = isCollapsed ? '78px' : '230px';
