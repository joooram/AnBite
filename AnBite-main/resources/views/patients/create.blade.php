...
<body>
    ...
    <main class="main">
        ...
        @if ($errors->any())
            <div class="error-box">
                <strong>Please fix the following:</strong> {{ $errors->first() }}
            </div>
        @endif
        ...
        <div class="form-group full">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full" id="other_animal_container" @style(['display: flex' => old('source_of_exposure') == 'other animal', 'display: none' => old('source_of_exposure') != 'other animal'])>
                        ...
                        <input type="text" name="other_animal_details" id="other_animal_details" value="{{ old('other_animal_details') }}" placeholder="e.g. Monkey, Bat, Rat, Snake..." style="border-color: #fed7aa;">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="select-wrap">
                            <select name="referred_clinic">
                                ...
                                <option value="Batangas City Health Office - Animal Bite Treatment Center" {{ old('referred_clinic') == 'Batangas City Health Office - Animal Bite Treatment Center' ? 'selected' : '' }}>
...
<div class="form-group">
    ...
    <div class="select-wrap">
        <select name="vaccine_days">
            <option value="" disabled selected>Select vaccine day</option>
            <option value="0" {{ old('vaccine_days') == '0' ? 'selected' : '' }}>Day 0</option>
            <option value="3" {{ old('vaccine_days') == '3' ? 'selected' : '' }}>Day 3</option>
            <option value="7" {{ old('vaccine_days') == '7' ? 'selected' : '' }}>Day 7</option>
            <option value="16" {{ old('vaccine_days') == '16' ? 'selected' : '' }}>Day 16</option>
            <option value="28" {{ old('vaccine_days') == '28' ? 'selected' : '' }}>Day 28</option>
        </select>
    </div>
</div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ─── LOGIC FOR BITE, SCRATCH, AND COMBINED ───
            function updateCategory() {
                ...
                if (exposureType === 'Non-Bite/Non-Scratch') {
                    ...
                    // Logic: Bite OR Scratch and Bite OR High Risk = Category 3
