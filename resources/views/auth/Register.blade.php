...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card-sub { font-size: 1rem; color: var(--text-light); margin-bottom: 2rem; transition: color 0.3s; text-align: center; }
        .card-sub a { color: var(--green-accent); font-weight: 600; text-decoration: none; }
        .card-sub a:hover { text-decoration: underline; }

        .error-box { background: #2d1010; border: 1px solid #5c1a1a; color: #e07070; border-radius: 8px; padding: 12px; margin-bottom: 1.2rem; font-size: 0.95rem; display: flex; align-items: center; gap: 7px; }

        .two-col { display: flex; gap: 12px; }
        .two-col .field { flex: 1; }
        .field { margin-bottom: 1.3rem; }
        
        /* Form Inputs & Labels (Pinalaki) */
        .field label { display: block; font-size: 1rem; font-weight: 500; color: var(--text-dark); margin-bottom: 8px; transition: color 0.3s; }
        .inp-wrap { position: relative; }
        .inp-wrap input { width: 100%; padding: 12px 42px; border: 1.5px solid var(--border); border-radius: 9px; font-size: 1.05rem; font-family: 'DM Sans', sans-serif; color: var(--text-dark); background: var(--input-bg); outline: none; transition: border-color 0.2s, box-shadow 0.2s, background 0.3s, color 0.3s; }
        ...
        .btn-submit { width: 100%; padding: 14px; background: var(--green-accent); color: white; border: none; border-radius: 9px; font-size: 1.1rem; font-weight: 600; font-family: 'DM Sans', sans-serif; cursor: pointer; position: relative; overflow: hidden; display: flex; align-items: center; justify-content: center; gap: 8px; transition: background 0.2s, transform 0.15s, box-shadow 0.2s; box-shadow: 0 3px 16px rgba(61,186,133,0.38); margin-top: 0.4rem; }
        ...
        /* Links (Pinalaki) */
        .back-link { display: block; text-align: center; margin-top: 1.2rem; font-size: 0.95rem; color: var(--green-accent); font-weight: 600; text-decoration: none; }
        .back-link:hover { text-decoration: underline; }
        .terms { margin-top: 1.6rem; font-size: 0.85rem; color: var(--terms-color); text-align: center; max-width: 440px; transition: color 0.3s; }
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('register') }}" id="registerForm">
                ...
                <div class="field">
                    ...
                    <div class="inp-wrap">
                        <span class="ico-left"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 10h18"/></svg></span>
                ...
                <div class="field">
                    ...
                    <div class="inp-wrap">
                        <span class="ico-left"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></span>
                ...
                <div class="field">
                    ...
                    <div class="inp-wrap">
                        ...
                        <button type="button" class="ico-right" id="tgl1"><svg id="eye1" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="inp-wrap">
                        ...
                        <button type="button" class="ico-right" id="tgl2"><svg id="eye2" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button>
                    </div>
                </div>
